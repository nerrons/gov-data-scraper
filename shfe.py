...
pm_button = driver.find_element_by_css_selector('#pm')
pm_button.click()
fu_a = driver.find_element_by_css_selector('#li_fu > a')
fu_a.click()
excel_a = driver.find_element_by_css_selector("p.excel_pic > a")
excel_a.click()
